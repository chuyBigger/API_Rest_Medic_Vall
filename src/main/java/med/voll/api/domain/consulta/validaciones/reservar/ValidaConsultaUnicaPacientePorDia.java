...
@Component
public class ValidaConsultaUnicaPacientePorDia implements ValidadorDeConsultas{
    ...
    public void validar(DatosReservaConsulta datos){
        ...
        if (pacienteTieneOtraConsultaEnElDia){
            throw new ValidacionException("EL paciente ya tiene otra consulta en el dia seleccionado");
        }
    }
}
